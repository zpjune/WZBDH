    ...
    public class ClsDataLoadSWKC : ISAPLoadInterface
    {
        ...
        public bool SAPLoadData(ClsSAPDataParameter p_para)
        {
            ...
            try
            {
                ...
                {
                    string sqlWLZ = @"  select  d.MATNR,d.MATKL,d.MAKTX,e.PMNAME,e.JBJLDW 
                                    FROM   MARA d 
                    ...
                    if (strBuilder.Length > 8)
                    {
                        ...
                        if (ClsUtility.ExecuteSqlToDb(" begin delete from CONVERT_SWKC; commit; end; "))
                        {
